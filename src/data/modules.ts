...
export const modules: ModuleItem[] = [
  ...
  { id: "hospital-profile", title: "Hospital Profile", icon: Hospital, description: "Branding, gallery & digital assets", route: "/hospital-profile", color: "bg-primary/10 text-primary" },
];
